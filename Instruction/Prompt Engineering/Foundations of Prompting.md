...
- Define what a prompt is in the context of AI and LLMs.
- Explain how prompts influence AI behavior and output.
- Identify characteristics of effective vs. ineffective prompts.
- Recognize the importance of clarity and specificity.
...
A) A type of software<br>
B) An instruction given to an AI model<br>
...
B) It improves the quality of the output<br>
...
A) The AI refuses to respond<br>
B) The output may be irrelevant or confusing<br>
C) The AI asks for clarification<br>
D) The AI becomes sentient (just kidding)<br>
...
- Prompts shape the **tone**, **depth**, and **accuracy** of AI responses.
- Good prompts are **clear**, **specific**, and **purpose-driven**.

## 🔍 Prompt Examples

| Prompt | Output Quality | Notes |
|--------|----------------|-------|
| "Tell me stuff" | ❌ Poor | Too vague |
| "Explain climate change" | ⚠️ Okay | Needs more context |
| "Summarize the causes of climate change in 3 bullet points for a high school student" | ✅ Great | Clear audience and format |

## 🧪 Try It Yourself

Write a prompt for each scenario below:

1. You need a summary of a 10-page report for your manager.
2. You want ideas for a team-building activity.
...
- Identify common types of prompts used in AI interactions.
- Understand the strengths and weaknesses of each prompt type.
- Choose appropriate prompt types for different tasks.
- Recognize how tone and structure influence AI responses.
...
|-------------|-------------|---------|
| Instructional | Direct command | “Summarize this article in 3 bullet points.” |
| Conversational | Casual, chat-like | “Hey, can you help me understand this?” | 
| Role-Based | Assigns a persona | “Act as a career coach and review my resume.” |
| Contextual | Includes background info | “Given the following data, write a report…” |
| Comparative | Asks for analysis | “Compare the pros and cons of remote work.” |
...
### Prompt Types:
- **Instructional**: Direct commands (e.g., “Summarize this article.”)
- **Conversational**: Casual, chat-like (e.g., “Can you help me understand this?”)
- **Role-Based**: Assigns a persona (e.g., “Act as a financial advisor.”)
- **Contextual**: Includes background info (e.g., “Given this data, write a report.”)
- **Comparative**: Asks for analysis (e.g., “Compare two strategies.”)

## 🧪 Try It Yourself

Write a prompt for each type below using the task: *“Help me decide on a new laptop.”*
...
## 📚 Suggested Reading
- [OpenAI Cookbook: Prompt Patterns](https://github.com/openai/openai-cookbook)
- [Anthropic: Role Prompting Guide](https://www.anthropic.com/index/prompt-engineering)
- [Prompt Engineering Guide](https://www.promptingguide.ai/)

## 💬 Reflection
Which prompt type do you think you'll use most in your work, and why?
...
- Break down the components of a well-structured prompt.
- Apply principles of clarity, specificity, and intent.
- Recognize common prompt pitfalls and how to avoid them.
...
| Constraints | 3 bullet points, concise |
...
| Mistake | Fix |
|---------|-----|
| “Write something” | “Write a 3-paragraph blog post about remote work trends.” |
| “Help me” | “Explain the concept of inflation in simple terms for a high school student.” |
| “Do it better” | “Revise this paragraph to sound more professional and concise.” |
...
A) It makes the AI faster<br>
B) It helps the AI understand the task<br>
C) It adds humor<br>
...
B) The format, tone, or length you want<br>
...
Rewrite the vague prompts below into strong ones:

1. “Help me with this.”
2. “Make it sound better.”
3. “Write something about meetings.”
...
## 📚 Suggested Reading
- [OpenAI: Best Practices for Prompting](https://platform.openai.com/docs/guides/gpt-best-practices)
- [Prompt Engineering Guide](https://www.promptingguide.ai/)
- [AI Literacy: Prompting for Clarity](https://www.aialiteracy.org/prompting)

## 💬 Reflection
Which component of prompt writing do you find most challenging, and why?
...
Participants are given 3 poorly written prompts. Their task is to:

- Identify what’s wrong (e.g., vague intent, missing context).
- Rewrite each prompt using the principles learned.

Example Prompts:

- “Do something with this data.”
- “Make this sound better.”
- “Write a thing about meetings.”

### Part 2: Prompt Creation
Participants choose one real-world task from their own work (e.g., summarizing a report, drafting an email, generating ideas) and:
...
- What changed in your approach to prompt writing?
